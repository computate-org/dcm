...
find \
  ...
  ~/.local/src/dcm/src/main/java/org/computate/dcm/model/eda/hostcredential/HostCredential.java \
  ~/.local/src/dcm/src/main/java/org/computate/dcm/model/eda/hostcredential/HostCredentialPage.java \
  ~/.local/src/dcm/src/main/java/org/computate/dcm/model/eda/hostcredential/HostCredentialEnUSApiServiceImpl.java \
